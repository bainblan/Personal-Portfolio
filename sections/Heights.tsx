...
import mountain from "../images/snowy-mountain-peak-stockcake.webp";

export default function Heights() {
    return (
        <>
            <section id="heights" className="flex flex-row items-center justify-center gap-[60px] w-full bg-[#D4AF37] px-[126px] py-[120px]">
