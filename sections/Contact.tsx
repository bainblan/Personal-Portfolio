    ...
    return (
        <div id="contact" className="flex w-full justify-center items-center px-[126px] py-[135px] bg-[#B2B2B2]">
            <div className="flex flex-col justify-between w-[786px] h-[670px]">
                ...
                <div className="flex flex-col text-[32px] justify-between w-full h-[518px]">
                    <div className="bg-[#333c66] text-white/63 px-[10px] py-[10px] rounded-[10px] w-full h-fit">
                        Name
                    </div>
                    <div className="bg-[#333c66] text-white/63 px-[10px] py-[10px] rounded-[10px] w-full h-fit">
                        Email
                    </div>
                    <div className="bg-[#333c66] text-white/63 px-[10px] py-[10px] rounded-[10px] w-full h-[222px]">
                        Message
                    </div>
