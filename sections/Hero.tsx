export default function Hero() {
    return (
        <div id="hero" className="content-stretch flex h-[809px] items-center justify-center overflow-clip p-[10px] relative shrink-0 w-full" data-name="Hero" style={{ backgroundImage: "linear-gradient(-89.6003deg, rgb(0, 0, 0) 0.19278%, rgb(102, 102, 102) 99.807%)" }}>
