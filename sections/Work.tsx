        ...
        <>
            <section id="work" className="flex flex-row items-center justify-center gap-[60px] w-full px-[126px] py-[120px]">
                <div className="flex flex-1 flex-col items-end gap-[30px] max-w-[600px]">
                    ...
                    <Link
                        href="/experience"
                        className="rounded-full bg-[#750af5] text-white px-[36px] py-[14px] text-[18px] font-semibold cursor-pointer transition-colors duration-200 hover:bg-[#001F3F]"
                    >
                        SEE EXPERIENCE
                    </Link>
                </div>
                <div className="flex-1 max-w-[620px] flex flex-row gap-[24px] p-[32px] rounded-[24px] border-2 border-[#750af5]">
