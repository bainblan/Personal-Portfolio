    ...
    return (
        <>
            <section id="work" className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-[60px] w-full px-6 md:px-[126px] py-16 md:py-[120px]">
                <RevealGroup className="flex w-full md:flex-1 flex-col items-start md:items-end gap-5 md:gap-[30px] max-w-[600px]">
                    <RevealItem as="h2" className="font-bold text-left md:text-right text-[48px] md:text-[96px] leading-[0.9]">PUTTING IN THE WORK</RevealItem>
                    <RevealItem>
                        <Link
                            href="/experience"
                            className="inline-block rounded-full bg-[#750af5] dark:bg-[#4c0a99] text-white px-[28px] md:px-[36px] py-[12px] md:py-[14px] text-[16px] md:text-[18px] font-semibold cursor-pointer transition-colors duration-200 hover:bg-[#001F3F] dark:hover:bg-[#a06bff]"
                        >
                            SEE EXPERIENCE
                        </Link>
                    </RevealItem>
                </RevealGroup>
                <Reveal delay={0.15} className="w-full md:flex-1 max-w-[620px] flex flex-row gap-3 md:gap-[24px] p-4 md:p-[32px] rounded-[24px] bg-[#750af5] dark:bg-[#4c0a99]">
